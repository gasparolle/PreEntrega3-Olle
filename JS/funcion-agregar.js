...
function agregarAuto (){
    ...
    botonSubmit.onclick = (e) => {
        ...
        formularioAlquilar.innerHTML="";
        const ingresoExitoso = document.createElement('h2');
        ingresoExitoso.innerText = '¡Su vehiculo ya fue publicado, \n gracias por utilizar nuestro servicio!';
        ingresoExitoso.className = 'operacionExitosa'
        formularioAlquilar.appendChild(ingresoExitoso);
    };
}